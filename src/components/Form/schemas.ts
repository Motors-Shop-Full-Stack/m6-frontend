...
export const registerSchema = yup.object().shape({
  ...
  cep: yup.string().required("Campo obrigatótio"),
  state: yup.string(),
  city: yup
    .string()
...
export const editProfileSchema = yup.object().shape({
  name: yup.string().max(50, "Máximo 50 caracteres"),
  email: yup.string(),
  cpf: yup.string(),
  cel: yup.string(),
...
export const editAddressSchema = yup.object().shape({
  ...
  street: yup.string().max(50, "Máximo 50 caracteres"),
  number: yup.string(),
  complement: yup.string().max(20, "Máximo 20 caracteres"),
});
